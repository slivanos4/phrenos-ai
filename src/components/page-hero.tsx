...
export function PageHero({
  ...
  return (
    <section className="relative isolate min-h-[100svh] overflow-hidden bg-[#0a0c0b]">
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,rgba(6,8,7,0.72)_0%,rgba(6,8,7,0.4)_30%,rgba(6,8,7,0.12)_55%,rgba(6,8,7,0.28)_100%),linear-gradient(180deg,rgba(6,8,7,0.5)_0%,transparent_18%,transparent_78%,rgba(6,8,7,0.55)_100%)]"
        aria-hidden
      />

      {hasCopy ? (
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-7xl items-start px-6 pt-28 sm:pt-32 lg:px-8 lg:pt-40">
